...
<%
	...
	String statement = "Select a.accountno,a.username,a.fname,a.lname,a.address,b.balance,a.phoneno,a.datecreated,a.status from NEWACCOUNT a join accountinfo b where a.accountno=b.accountno";
	PreparedStatement ps = con.prepareStatement(statement);
	ResultSet rs=ps.executeQuery();
	out.print("<br><br><br>");
	out.print("<div align='center'><form action='PullRecords' method='post'>");
	out.print("<table align='left'  cellspacing='5' cellpadding='3' bgcolor='orange' border='1'>");
	...
	out.print("<input type='hidden' name='checkVal' value='1'>");
	out.print("<input type='submit' value='Generate PDF'>");
	out.print("<br></form></div>");
%>
</div>
<div id="footer_top">
