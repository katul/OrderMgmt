...
<div style="width:897px; background:#FFFFFF; margin:0 auto; height: 450px">
	...
	<div class="row" style="margin-top:10%;">
		<button onclick="window.location.href='neworder.jsp'" type="button" style="margin-left:25%;margin-right:15;">New Order</button>
	</div>
	<div class="row" style="margin-top:10%;">
		<button onclick="window.location.href='vieworder.jsp'" type="button" style="margin-left:75%;margin-right:15;">View Order</button>
	</div>
	<div class="row" style="margin-top:10%;">
		<button onclick="window.location.href='editorder.jsp'" type="button" style="margin-left:25%;margin-right:15;">Edit Order</button>
	</div>
  </div>
