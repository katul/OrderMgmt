...
<div style="width:897px; background:#FFFFFF; margin:0 auto; height: 450px">
	<%
		...
		PreparedStatement ps = con.prepareStatement("Select count(accountno) from newaccount");
		ResultSet rs = ps.executeQuery();
		if(rs.next()){
			usercount = rs.getInt(1);
		}
		PreparedStatement ps1 = con.prepareStatement("Select count(cardno) from creditcard");
		ResultSet rs1 = ps1.executeQuery();
		if(rs1.next()){
			cardcount = rs1.getInt(1);
		}
	%>
	
	<br><br><br><br><br><br>
	<div align="center"> Total Number of Account holders : <%=usercount %></div><br><br><br><br><br><br>
	
	<div align="center"> Total Number of Credit Card holders : <%=cardcount %></div>
</div>
<div id="footer_top">
